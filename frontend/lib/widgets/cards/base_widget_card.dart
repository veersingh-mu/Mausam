...
import '../../core/responsive/responsive_hover_card.dart';
...
/// Supports both native touch on mobile/tablet and hover/pointer states on desktop.
abstract class BaseWidgetCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveHoverCard(
      onTap: onTap,
      margin: EdgeInsets.zero,
      hoverColor: persona.color.withOpacity(0.04),
